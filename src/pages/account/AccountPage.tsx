...
function AccountPage({}: Props) {
	...
	const avatarImage = useAvatar(user!.avatar.id);
		...
		<>
			...
			>
				...
				<Flex justify="space-evenly" gap={8} mt={20}>
					<Button w="100%" variant="light" color="violet">Confirm</Button>
					<Button w="100%" variant="light" color="gray">Cancel</Button>
				</Flex>
			</Modal>
			<Box p={32}>
				<Container size="90%">
